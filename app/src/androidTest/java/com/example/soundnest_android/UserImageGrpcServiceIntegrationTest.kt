...
const val TOKKEN_JWT_USER_IMAGE= "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywidXNlcm5hbWUiOiIyIiwiZW1haWwiOiJ6czIyMDEzNjk4YWFAZXN0dWRpYW50ZXMudXYubXgiLCJyb2xlIjoyLCJpYXQiOjE3NDczMzg5MTgsImV4cCI6MTc0NzQyMTcxOH0.EiMrrlIka26PcID1J72R6RN32ExPsMRVvEaKjcx7pKQ"
...
class UserImageGrpcServiceIntegrationTest {
    ...
    fun  uploadImageRealCall() = runBlocking {
        ...
        val service = UserImageGrpcService(GrpcRoutes.getHost(), GrpcRoutes.getPort()) { TOKKEN_JWT_USER_IMAGE }
